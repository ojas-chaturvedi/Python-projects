...
def hangman_game_boring():
    ...
    while music == True:
        player = tkr.Tk()
        player.title('The Hanging Tree -- Mockingjay')
        player.geometry('300x300')
        label1 = tkr.LabelFrame(player, text = 'Please close this window after the music starts')
        label1.pack(fill='both', expand = 'yes')
        file = ('The Hanging Tree - MUSIC VIDEO - [The Hunger Games Mockingjay Pt.1 Score (James Newton Howard)].mp3')
        pygame.init()
        pygame.mixer.init()
...
while str(turn) != ppl:
    ...
    print('** plz open the music window and after the music starts, close the window')
